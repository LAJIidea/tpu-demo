...
namespace tpu_mlir {
    namespace top {
        ...
        public:
            ...
            LogicalResult matchAndRewrite(UnTupleOp op, PatternRewriter &rewriter) const override {
        ...
        public:
            ...
            LogicalResult matchAndRewrite(TupleOp op, PatternRewriter &rewriter) const override {
        ...
        public:
            ...
            LogicalResult matchAndRewrite(WeightOp op, PatternRewriter &rewriter) const override {
        ...
        static void WeightFolder(Operation *op) {
            ...
            std::vector<std::vector<float>> datas(5);
        ...
        private:
            bool removeIfNoUse(Operation *op) {
                ...
                if (op->getUsers().empty()
                    && !isa<tpu::IfOp, tpu::LoopOp, top::LoopOp, top::IfOp>(op->getBlock()->getParentOp())) {
                    op->erase();
                    return true;
                }
                return false;
